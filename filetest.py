...
print(path)
path = "/scratch/spahlmar/savanna/data/evo/pretraining_or_both/gtdb_v220_imgpr/"
print(path)
files = [f for f in listdir(path)]
print(files)

train_path = "/scratch/spahlmar/savanna/data/evo/pretraining_or_both/gtdb_v220_imgpr/data_gtdb_train_chunk1_text_CharLevelTokenizer_document"
